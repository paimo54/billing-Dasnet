    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
        <div class="mb-2 mb-md-0">
            ...
            <p class="text-muted mb-0">
                <i class="fas fa-info-circle"></i> Tambahkan pelanggan baru ke sistem dengan informasi lengkap
            </p>
        </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit mr-1"></i>Form Data Pelanggan
                    </h3>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone') }}" required placeholder="081234567890">
                                    </div>
                                    @error('phone')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control @error('billing_date') is-invalid @enderror" id="billing_date" name="billing_date" value="{{ old('billing_date') ?? date('Y-m-d') }}" required>
                                    </div>
                                    @error('billing_date')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('latitude') is-invalid @enderror" id="latitude" name="latitude" value="{{ old('latitude') }}" placeholder="-6.2088">
                                    </div>
                                    @error('latitude')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('longitude') is-invalid @enderror" id="longitude" name="longitude" value="{{ old('longitude') }}" placeholder="106.8456">
                                    </div>
                                    @error('longitude')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control @error('package_id') is-invalid @enderror" id="package_id" name="package_id" required>
                                    ...
                                    @foreach ($packages as $package)
                                        <option value="{{ $package->id }}" {{ old('package_id') == $package->id ? 'selected' : '' }} data-price="{{ $package->price }}" data-type="{{ $package->type }}">
        ...
        <div class="col-md-4">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <div id="package-info" class="text-center py-4">
                    ...
                    <div id="package-details" style="display: none;">
                        <div class="text-center mb-3">
                            ...
                            <h5 id="package-name" class="mb-1"></h5>
                            <span id="package-type" class="badge badge-primary"></span>
                        </div>
                        ...
                        <div class="package-details">
                            <div class="detail-item mb-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span id="package-price" class="font-weight-bold text-success"></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <i class="fas fa-check-circle text-success mr-2"></i>
                            Koordinat GPS membantu untuk tracking lokasi
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check-circle text-success mr-2"></i>
                            Tanggal tagihan menentukan jadwal billing
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="help-modal-label">
                        <i class="fas fa-question-circle mr-2"></i>Panduan Tambah Pelanggan
                    </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted">Isi informasi lengkap pelanggan termasuk nama, email, dan telepon.</p>
                            
                            <h6><i class="fas fa-map-marker-alt text-warning"></i> Alamat & Koordinat</h6>
                            <p class="text-muted">Masukkan alamat lengkap dan koordinat GPS untuk tracking lokasi.</p>
                        </div>
                        <div class="col-md-6">
                            <h6><i class="fas fa-box text-success"></i> Paket Internet</h6>
                            <p class="text-muted">Pilih paket internet yang sesuai dengan kebutuhan pelanggan.</p>
                            
                            <h6><i class="fas fa-calendar-alt text-info"></i> Tanggal Tagihan</h6>
                            <p class="text-muted">Tentukan tanggal jatuh tempo tagihan bulanan pelanggan.</p>
                        </div>
                    </div>
