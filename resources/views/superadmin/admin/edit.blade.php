    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
        <div class="mb-2 mb-md-0">
            ...
            <p class="text-muted mb-0">
                <i class="fas fa-info-circle"></i> Perbarui data admin {{ $admin->name }}
            </p>
        </div>
    ...
    <div class="row">
        <div class="col-lg-8 col-md-12">
            <div class="card card-outline card-warning">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit mr-1"></i>Form Edit Admin
                    </h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('superadmin.admins.update', $admin->id) }}" method="POST" id="admin-form">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                <i class="fas fa-info-circle"></i> Admin yang tidak aktif tidak dapat login ke sistem
                            </small>
                        </div>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-user-shield mr-1"></i>Info Admin
                    </h3>
                </div>
                <div class="card-body">
                    <div class="text-center mb-3">
                        ...
                        <h5 class="mt-2 mb-1">{{ $admin->name }}</h5>
            ...
            <div class="card card-outline card-warning mt-3">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <p class="mb-0">Kosongkan field password jika tidak ingin mengubah password admin.</p>
                    </div>
                    
                    <div class="alert alert-warning">
                        <h6><i class="fas fa-toggle-on text-success"></i> Status Aktif</h6>
                        <p class="mb-0">Nonaktifkan admin jika tidak ingin admin tersebut login ke sistem.</p>
                    </div>
                    
                    <div class="alert alert-success">
                        <h6><i class="fas fa-save text-primary"></i> Menyimpan</h6>
                        <p class="mb-0">Klik "Simpan Perubahan" untuk mengupdate data admin.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h5 class="modal-title text-white" id="help-modal-label">
                        <i class="fas fa-question-circle mr-2"></i>Panduan Edit Admin
                    </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted">Edit nama dan email admin. Email harus unik dan valid.</p>
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="text-muted">Aktifkan/nonaktifkan admin. Admin yang tidak aktif tidak dapat login.</p>
                        </div>
                    </div>
                </div>
