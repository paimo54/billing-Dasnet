...
@section('content_header')
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
        <div class="mb-2 mb-md-0">
            <h1 class="mb-1">
                <i class="fas fa-user-edit mr-2"></i>Edit Teknisi
            </h1>
            <p class="text-muted mb-0">
                <i class="fas fa-info-circle"></i> Perbarui data teknisi {{ $technician->name }}
            </p>
        </div>
        <div class="d-flex flex-wrap gap-2">
            <a href="{{ route('superadmin.technicians.index') }}" class="btn btn-secondary">
    ...
    <div class="row">
        <div class="col-lg-8 col-md-12">
            <div class="card card-outline card-warning">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <span class="badge badge-warning mr-2">
                            <i class="fas fa-asterisk"></i> Password Opsional
                        </span>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('superadmin.technicians.update', $technician->id) }}" method="POST" id="technician-form">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        <i class="fas fa-info-circle"></i> Masukkan nama lengkap teknisi
                                    </small>
                                </div>
                            </div>
                            <div class="col-md-6">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-user-cog mr-1"></i>Info Teknisi
                    </h3>
                </div>
                <div class="card-body">
                    <div class="text-center mb-3">
                        <div class="avatar-placeholder bg-success text-white rounded-circle d-inline-flex align-items-center justify-content-center" style="width: 80px; height: 80px; font-size: 2rem;">
                            <i class="fas fa-user-cog"></i>
                        </div>
                        <h5 class="mt-2 mb-1">{{ $technician->name }}</h5>
                    ...
                    <div class="info-item mb-3">
                        ...
                        <div>{{ $technician->phone ?? 'Tidak ada' }}</div>
                    </div>
            ...
            <div class="card card-outline card-warning mt-3">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <p class="mb-0">Kosongkan field password jika tidak ingin mengubah password teknisi.</p>
                    </div>
                    
                    <div class="alert alert-warning">
                        <h6><i class="fas fa-toggle-on text-success"></i> Status Aktif</h6>
                        <p class="mb-0">Nonaktifkan teknisi jika tidak ingin teknisi tersebut login ke sistem.</p>
                    </div>
                    
                    <div class="alert alert-success">
                        <h6><i class="fas fa-save text-primary"></i> Menyimpan</h6>
                        <p class="mb-0">Klik "Simpan Perubahan" untuk mengupdate data teknisi.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted">Edit nama dan email teknisi. Email harus unik dan valid.</p>
                            
                            <h6><i class="fas fa-lock text-warning"></i> Password</h6>
                            <p class="text-muted">Kosongkan field password jika tidak ingin mengubah password. Jika diisi, password harus minimal 8 karakter.</p>
                        </div>
                        <div class="col-md-6">
                            <h6><i class="fas fa-phone text-success"></i> Kontak</h6>
                            <p class="text-muted">Update nomor telepon untuk kontak darurat (opsional).</p>
                            
                            <h6><i class="fas fa-toggle-on text-info"></i> Status</h6>
                            <p class="text-muted">Aktifkan/nonaktifkan teknisi. Teknisi yang tidak aktif tidak dapat login.</p>
                        </div>
                    </div>
                </div>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            // Password strength checker (only when password is entered)
            ...
            // Password confirmation checker (only when password is entered)
            ...
            function validateForm() {
                ...
                if (password.length > 0) {
                    ...
                    confirmValid = checkPasswordMatch();
                }
