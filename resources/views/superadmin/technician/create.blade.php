...
@section('content_header')
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
        <div class="mb-2 mb-md-0">
            <h1 class="mb-1">
                <i class="fas fa-user-plus mr-2"></i>Tambah Teknisi
            </h1>
            <p class="text-muted mb-0">
                <i class="fas fa-info-circle"></i> Buat akun teknisi baru untuk input data pelanggan dan layanan teknis
            </p>
        </div>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="card card-outline card-success">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit mr-1"></i>Form Tambah Teknisi
                    </h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('superadmin.technicians.store') }}" method="POST" id="technician-form">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <p class="mb-0">Pastikan email yang digunakan belum terdaftar di sistem. Email ini akan digunakan untuk login teknisi.</p>
                    </div>
                    
                    <div class="alert alert-info">
                        <h6><i class="fas fa-user-cog text-primary"></i> Hak Akses Teknisi</h6>
                        <p class="mb-0">Teknisi yang dibuat akan memiliki akses untuk input data pelanggan dan memberikan layanan teknis.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="text-muted">Klik "Simpan Teknisi" untuk menyimpan data. Pastikan semua field wajib sudah terisi dengan benar.</p>
                        </div>
                    </div>
                </div>
